...
from model_multihead import ModelMultiHeadHierarchical, CombinedLossFlexible
...
if __name__ == '__main__':
    ...
    print('='*60)
    model = ModelMultiHeadHierarchical(args, device)
    ...
    # criterion = CombinedLossFlexible(
    #     weight=weight,
    ...
    for epoch in range(args.num_epochs):
        ...
        # Run interpretability analysis every epoch
        if args.analyze_interpretability:
