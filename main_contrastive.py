...
from model_contrastive import ModelContrastive, CombinedLoss
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='ASVspoof2021 Contrastive Learning System')
    ...
    model_tag = 'model_contrastive_{}_{}_{}_{}_{}'.format(
    ...
    model = ModelContrastive(args, device)
