"""Full test with 500 samples for statistical significance."""
import sys
sys.stdout.write("Python script started, importing modules...\n")
sys.stdout.flush()
import torch
...
print('='*60)
print('FULL TEST: 500 samples for statistical significance')
print('='*60)
...
with torch.no_grad():
    for batch_x, _ in eval_loader:
        ...
        for b in range(sparse_features.shape[0]):
            ...
            count += 1
            print(f'  Processed {count}/500 samples', flush=True)
...
if discriminative_lifetimes and non_discriminative_lifetimes:
    ...
    print('\n✅ Hypothesis validated with 500 samples!')
else:
    print('\n⚠️ Insufficient data in 500 samples')
