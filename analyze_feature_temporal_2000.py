"""Full test with 2000 samples for statistical significance."""
import torch
...
print('='*60)
print('FULL TEST: 2000 samples for statistical significance')
print('='*60)
...
if discriminative_lifetimes and non_discriminative_lifetimes:
    ...
    print('\n✅ Hypothesis validated with 2000 samples!')
else:
