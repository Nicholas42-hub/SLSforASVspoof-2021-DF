#!/usr/bin/env python
"""
Evaluate trained model on ASVspoof 2021 LA evaluation set
"""
import argparse
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='Evaluate on ASVspoof 2021 LA')
    ...
    # Create model
    print(f'\nCreating model with sae_k={args.sae_k}, use_sparse_features={use_sparse_features}')
    model = Model(
        args=dummy_args,
        device=device,
