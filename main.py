...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='ASVspoof2021 Mamba-based Hierarchical Attention System')
    ...
    # Mamba parameters (可选，用于未来扩展)
    parser.add_argument('--mamba_d_state', type=int, default=16,
                        help='Mamba SSM state expansion factor')
    ...
    model_tag = 'model_mamba_hierarchical_{}_{}_{}_{}_{}'.format(
