#!/usr/bin/env python
"""
Evaluate window topk model on ASVspoof 2021 LA evaluation set - using torchaudio
"""
import argparse
import os
import sys
...
def main():
    parser = argparse.ArgumentParser(description='Evaluate window topk on ASVspoof 2021 LA with torchaudio')
    ...
    parser.add_argument('--output_file', type=str, default='scores/window_topk_w8_2021LA_scores.txt', help='Output score file')
